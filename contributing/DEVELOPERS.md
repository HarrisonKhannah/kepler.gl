...
* Update each of the example folder package.json kepler.gl dependency with the newer. This step is required after the enw version is published otherwise it would fail.
